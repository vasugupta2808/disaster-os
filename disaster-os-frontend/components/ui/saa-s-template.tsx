...
const Hero = React.memo(() => {
  return (
    ...
    >
      ...
      <aside className="mb-8 mt-12 inline-flex flex-wrap items-center justify-center gap-2 px-4 py-2 rounded-full border border-gray-700 bg-gray-800/50 backdrop-blur-sm max-w-full">
      ...
      <div className="w-full max-w-5xl relative pb-20">
        <div
          ...
          aria-hidden="true"
        >
          {/* Replaced broken image with an abstract blurred gradient as a glow */}
          <div className="w-full h-[600px] bg-indigo-500/20 blur-[120px] rounded-full mx-auto max-w-3xl" />
        </div>
